   ...
   <section>
     <div className="header bg-green-600 p-10 ">
             <div className="flex items-center gap-x-4">
                 ...
                 <Image src="https://ecommerce.routemisr.com/Route-Academy-categories/1681511818071.jpeg" width={100} height={100} alt="electronics" className=" h-full "/>
 
             </div>
             <div className="text text-white">
                 <h1 className="text-4xl font-bold">Women's Fashion</h1>
                 <p className="text-gray-200">Browse products in Women's Fashion</p>
             </div>
             </div>
