  ...
  <section>
    <div className="header bg-green-600 p-10 ">
            <div className="flex items-center gap-x-4">
                ...
                <Image src='https://ecommerce.routemisr.com/Route-Academy-categories/1681511964020.jpeg' width={100} height={100} alt="electronics" className=" h-full "/>

            </div>
            <div className="text text-white">
                <h1 className="text-4xl font-bold">Electronics</h1>
                <p className="text-gray-200">Browse products in Electronics</p>
            </div>
            </div>
