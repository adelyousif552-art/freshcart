...
export default function Cartscreen() {
  ...
  <section className="my-10 mx-4">
    ...
    <div className="header space-y-2 ">
       <div className="flex items-center gap-x-3">
         <div className="icon w-12 h-12 rounded-xl bg-linear-to-r from-green-600 to-green-800 flex items-center justify-center">
            <FontAwesomeIcon icon={faCartShopping as IconProp} className="text-white text-2xl" />
        </div>
        <div className="text">
        ...
        <div className="cartsummary col-span-3 shadow-lg rounded-lg">
            ...
            <div className="p-5">
                ...
                <div className="buttons space-y-3">
                    <button className="w-full space-x-2 border border-gray-400/40 hover:text-green-500 hover:bg-green-200/20 hover:border-green-200/20 cursor-pointer transition-colors duration-200 rounded-2xl border-dotted py-4 px-3"><FontAwesomeIcon icon={faTag as IconProp} /><span>Apply Promo Code</span></button>
                    <button onClick={()=>{
                        router.push('/checkout')

                    }} className="w-full space-x-2 border bg-green-600 hover:bg-green-800 cursor-pointer transition-colors duration-200 rounded-2xl  py-4 shadow-2xl px-3"><FontAwesomeIcon icon={faLock as IconProp} className="text-white" /><span className="text-white font-bold">Secure Checkout</span></button>
    ...
    <div className="cart-empty flex flex-col items-center justify-center mt-10 p-10 rounded-3xl shadow-lg bg-green-50">
        <FontAwesomeIcon icon={faCartShopping as IconProp} className="text-green-400 text-6xl mb-4" />
        ...
        <Link className="text-green-600 space-x-2 hover:text-green-800 text-lg font-semibold flex items-center" href={'/shop'}>
            <FontAwesomeIcon icon={faArrowLeft as IconProp}/><span>Continue Shopping</span>
        </Link>
    </div>
</div>
        }
