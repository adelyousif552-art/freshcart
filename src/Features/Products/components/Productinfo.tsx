     ...
     <div>
        ...
        <div className="border w-fit border-gray-400/60  ">
          <button className="hover:bg-gray-200/40 transition-colors duration-200 cursor-pointer p-4" onClick={()=>{
            setcount(count-1)
          }}><FontAwesomeIcon icon={faMinus as IconProp}/></button>
          ...
          <button className="p-4 hover:bg-gray-200/40 transition-colors duration-200 cursor-pointer" onClick={()=>{
            setcount(count+1)
          }}><FontAwesomeIcon icon={faPlus as IconProp}/></button>
      ...
      <div className="price flex items-center justify-between bg-gray-300/20 p-2">
        ...
        <span className="text-2xl text-green-600 font-bold">{(priceAfterDiscount !== undefined ? priceAfterDiscount * count : price * count)}EGP</span>

      </div>
      <div className="buttons flex *:grow items-center space-x-2">
        <button className="text-white rounded-2xl px-2 py-4 space-x-2 bg-green-600 cursor-pointer hover:bg-green-800 transition-colors duration-200 "><FontAwesomeIcon icon={faCartShopping as IconProp} /><span>Add to Cart</span></button>
      ...
      <div className="wishlistbtn&sharebtn flex gap-x-2 *:cursor-pointer">
        <button className="bg-white text-red-500 rounded-2xl border border-red-500/50 w-10/12 py-4 px-2"><FontAwesomeIcon icon={faHeart as IconProp}/> <span>in Wishlist</span></button>
        <button className="hover:text-green-600 border hover:border-green-600 transition-colors duration-200 py-4 px-2  rounded-2xl grow"><FontAwesomeIcon icon={faShareNodes as IconProp}/></button>
      ...
      <div className="icons flex items-center *:grow">
        <div className="flex items-center gap-x-2">
          ...
          <FontAwesomeIcon icon={faTruck as IconProp} className="text-green-400"/>
        </div>
        <div className="text">
          <h1>Free Delivery</h1>
         ...
         <div className="flex items-center gap-x-2">
          <div className="icon w-12 h-12 bg-green-300/40 flex items-center justify-center rounded-full">
          <FontAwesomeIcon icon={faRotateLeft as IconProp} className="text-green-400"/>
        </div>
        <div className="text">
         ...
         <div className="flex items-center gap-x-2">
          <div className="icon w-12 h-12 bg-green-300/40 flex items-center justify-center rounded-full">
          <FontAwesomeIcon icon={faShieldHalved as IconProp} className="text-green-400"/>
        </div>
        <div className="text">
  ...
  <section className="tabs">
    <div className="buttons flex items-center *:space-x-2  *:p-6">
     <div className={`productdetails  transition-colors duration-200 border-b ${detailsisopen?'border-green-600 bg-green-300/20 text-green-500':''} border-gray-400/50`}>
       <span><FontAwesomeIcon icon={faInfo as IconProp} /></span>
      <Link href={''} onClick={()=>{
     ...
     <div className={`productdetails  transition-colors duration-200 border-b ${reviewsisopen?'border-green-600 bg-green-300/20 text-green-500':''} border-gray-400/50`}>
       <span><FontAwesomeIcon icon={faStar as IconProp} /></span>
      <Link  href={''} onClick={()=>{
     ...
     <div className={`productdetails  transition-colors duration-200 border-b ${shippingisopen?'border-green-600 bg-green-300/20 text-green-500':''} border-gray-400/50`}>
       <span><FontAwesomeIcon icon={faTruck as IconProp} /></span>
      <Link onClick={()=>{
    ...
    <div className="keyfeatures p-3 bg-gray-300/30 rounded-lg space-y-5 ">
      ...
      <ul>
        <li><FontAwesomeIcon icon={faCheck as IconProp} className="text-green-600" /> <span>Premium Quality Product</span></li>
        <li><FontAwesomeIcon icon={faCheck as IconProp} className="text-green-600" /> <span>100% Authentic Guarantee</span></li>
        <li><FontAwesomeIcon icon={faCheck as IconProp} className="text-green-600" /> <span>Fast & Secure Packaging</span></li>
        <li><FontAwesomeIcon icon={faCheck as IconProp} className="text-green-600" /> <span>Quality Tested</span></li>
   ...
   {shippingisopen? <div className="shipping">
      <div className="grid grid-cols-2">
        <div className="shippinginformation mx-8 my-8 p-5 bg-green-300/30 space-y-3">
          ...
          <ul>
            <li><FontAwesomeIcon icon={faCheck as IconProp} className="text-green-600"/> <span>Free shipping on orders over $50</span></li>
             <li><FontAwesomeIcon icon={faCheck as IconProp} className="text-green-600"/> <span>Standard delivery: 3-5 business days</span></li>
              <li><FontAwesomeIcon icon={faCheck as IconProp} className="text-green-600"/> <span>Express delivery available (1-2 business days)</span></li>
               <li><FontAwesomeIcon icon={faCheck as IconProp} className="text-green-600"/> <span>Track your order in real-time</span></li>
          </ul>
        </div>
        <div className="refunds bg-green-300/30 p-5 mx-8 my-8 space-y-3">
         <div className="flex items-center space-x-2">
            <div className="icon  w-12 h-12 bg-green-300/30 flex items-center justify-center rounded-full">
            <FontAwesomeIcon icon={faRotateLeft as IconProp} className="text-green-600"/>

          </div>
          <h1 className="font-semibold">Returns & Refunds</h1>
          </div>
          <ul>
            <li><FontAwesomeIcon icon={faCheck as IconProp} className="text-green-600"/> <span>30-day hassle-free returns</span></li>
             <li><FontAwesomeIcon icon={faCheck as IconProp} className="text-green-600"/> <span>Full refund or exchange available</span></li>
              <li><FontAwesomeIcon icon={faCheck as IconProp} className="text-green-600"/> <span>Free return shipping on defective items</span></li>
               <li><FontAwesomeIcon icon={faCheck as IconProp} className="text-green-600"/> <span>Easy online return process</span></li>
          </ul>
